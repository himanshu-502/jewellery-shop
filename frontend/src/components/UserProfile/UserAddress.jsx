...
const UserAddress = () => {
    const { address, updateAddresses } = useUserProfileStore();
    ...
    return (
        <div className='useraddress'>
            ...
            <div className='addressin'>
                {newAddresses.map((addr, index) => (
                    <div className='address' key={index}>
                        ...
                        />
                        <div className='delbtn' onClick={() => handleRemoveAddress(index)}>
            ...
            <div className='addnewbtn' onClick={handleAddNewAddress}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
